...
<div class="form-group field-profile-phone">
<?php echo Html::label($paymentProfile->getAttributeLabel('ach_account_name'), 'ach_2', ['class' => 'col-lg-3 control-label']) ?>
    <div class="col-lg-8">
...
<div class="form-group field-profile-phone">
<?php echo Html::label($paymentProfile->getAttributeLabel('ach_account_number'), 'ach_3', ['class' => 'col-lg-3 control-label']) ?>
    <div class="col-lg-8">
...
<div class="form-group field-profile-phone">
<?php echo Html::label($paymentProfile->getAttributeLabel('fullname'), 'f_n', ['class' => 'col-lg-3 control-label']) ?>
    <div class="col-lg-8">
