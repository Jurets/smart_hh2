...
/*
 * Subcategories panel
 * Use for rendering 4 checkbox panel for subcategories manipulation
 */
?>
...
<div class="right-column choice-categories col-xs-12 col-sm-12 col-md-12 col-lg-5">
    ...
    <p class="commentary"><?=Yii::t('app',"You can choose up to 4 categories and 12 subcategories")?></p>
